...
public class setProfile extends AppCompatActivity {
    ...
    private void sendDataTORealTimeDatabase()
    {
        ...
        Toast.makeText(getApplicationContext(), " Send to RealTime DB ", Toast.LENGTH_SHORT).show();
        sendImagetoStoage();

    }

    private void sendImagetoStoage()
    {
        ...
        Toast.makeText(getApplicationContext(), "Putting image to storage", Toast.LENGTH_SHORT).show();
    ...
    private void sendDataTocloudFirestore() {
        ...
        documentReference.set(userdata).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(getApplicationContext(), "Data On Cloud FireStore Sent Sucessfully", Toast.LENGTH_SHORT).show();
